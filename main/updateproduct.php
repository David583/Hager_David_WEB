...
rmdir_recursive($_SERVER['DOCUMENT_ROOT'].'/products/product_'. $oldhtml);
if (mkdir($_SERVER['DOCUMENT_ROOT'].'/products/product_'. $dirname . '/', 0777) == false) {
	die("A megadott mappa már létezik!");
}
...
$gname = $row[0]["GroupID"];
$sql = "UPDATE productlist SET Product_HTML = '$dirname', Product_Name = '$title', Product_GroupID = '$gname' WHERE Product_Name = '$oldname'";
